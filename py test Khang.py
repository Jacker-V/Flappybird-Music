...
def draw_bg():
    if dem_bg==0:
        screen.blit(bg_3,(bg_x_pos,0))
        screen.blit(bg,(bg_x_pos+768,0))
    elif dem_bg==1:
        screen.blit(bg,(bg_x_pos,0))
        screen.blit(bg,(bg_x_pos+768,0))
    elif dem_bg==2:
        screen.blit(bg_1,(bg_x_pos,0))
        screen.blit(bg_2,(bg_x_pos+768,0))
    elif dem_bg==3:
        screen.blit(bg_2,(bg_x_pos,0))
        screen.blit(bg_2,(bg_x_pos+768,0))
...
def check_collision_1(pipes):
    for pipe in pipes:
        if bird1_rect.colliderect(pipe):
            hit_sound.play()  
            return False
    if bird1_rect.top <= -25 or bird1_rect.bottom >= 650:
            hit_sound.play()
            return False 
    return True 
...
def score_display(game_state):
    if game_state == 'main game':
        score_surface = game_font.render(str(int(score)),True,(255,0,0))
...
def screen_pick_music():    
    ...
    if dem_music==1:
        music_surface_1 =pygame.image.load('assets/38.png').convert_alpha()
        screen.blit(music_surface_1,(30,80))
    elif dem_music==2:
        music_surface_2 =pygame.image.load('assets/23.png').convert_alpha()
        screen.blit(music_surface_2,(30,180))
    elif dem_music==3:
        music_surface_3 =pygame.image.load('assets/24.png').convert_alpha()
        screen.blit(music_surface_3,(30,290))
    elif dem_music==4:
        music_surface_4 =pygame.image.load('assets/25.png').convert_alpha()
        screen.blit(music_surface_4,(30,390))
    elif dem_music==5:
        music_surface_5 =pygame.image.load('assets/26.png').convert_alpha()
        screen.blit(music_surface_5,(500,80))
    elif dem_music==6:
        music_surface_6 =pygame.image.load('assets/36.png').convert_alpha()
        screen.blit(music_surface_6,(500,180))
    elif dem_music==7:
        music_surface_7 =pygame.image.load('assets/27.png').convert_alpha()
        screen.blit(music_surface_7,(500,290))
    elif dem_music==8:
        music_surface_8 =pygame.image.load('assets/28.png').convert_alpha()
        screen.blit(music_surface_8,(500,390))
    

    
def screen_pick_bird():
    screen.blit(screen_waitting,(0,0))
    choice_surface=pygame.image.load('assets/khung_chon.png').convert_alpha()
    choice_surface = pygame.transform.scale2x(choice_surface)
    screen.blit(choice_surface,(150,300))
    screen.blit(choice_surface,(450,300))
    ...
    screen.blit(flappy_surface_1,(205,360))
    ...
    screen.blit(flappy_surface_2,(505,360))
    exit_surface = pygame.image.load('assets/14.png').convert_alpha()
    screen.blit(exit_surface,(280,600))
...
def screen_bird():
    ...
    if dem_chim_1==1:
        ...
        screen.blit(flappy_surface_2,(205,360))
    else:
        screen.blit(flappy_surface_3,(205,360))
    if dem_chim_2==1:
        screen.blit(flappy_surface_2,(505,360))
    elif dem_chim_2==2:
        screen.blit(flappy_surface_3,(505,360))
    else:
        screen.blit(flappy_surface_1,(505,360))
...
def screen_pick_mode():
    ...
    if dem_mode==1:
        mode_surface_1= pygame.image.load('assets/29.png').convert_alpha()
        screen.blit(mode_surface_1,(280,200))
    elif dem_mode==2:
        mode_surface_2= pygame.image.load('assets/31.png').convert_alpha()
        screen.blit(mode_surface_2,(280,300))
...
def screen_pick_place():
    ...
    exit_surface = pygame.image.load('assets/14.png').convert_alpha()
    screen.blit(exit_surface,(280,600))   
    flappy_surface_3=pygame.image.load('assets/33.png').convert_alpha()
    #flappy_surface_3 = pygame.transform.scale2x(flappy_surface_3)
    screen.blit(flappy_surface_3,(280,200))
    flappy_surface_4=pygame.image.load('assets/32.png').convert_alpha()
    #flappy_surface_3 = pygame.transform.scale2x(flappy_surface_3)
    screen.blit(flappy_surface_4,(280,300))
    if dem_place==1:
        flappy_surface_3=pygame.image.load('assets/34.png').convert_alpha()
        screen.blit(flappy_surface_3,(280,200))
    elif dem_place==2:
        flappy_surface_3=pygame.image.load('assets/35.png').convert_alpha()
        screen.blit(flappy_surface_3,(280,300))
...
bg_1 = pygame.image.load('assets/back6.png').convert()
bg_1 = pygame.transform.scale2x(bg_1)

bg_2 = pygame.image.load('assets/back7.png').convert()
bg_2 = pygame.transform.scale2x(bg_2)

bg_3 = pygame.image.load('assets/back4.png').convert()
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and game_active == False:
            if page==0 :
                ...
                if mouse_x>=350 and mouse_x<=450 and mouse_y>=670 and mouse_y<=750:
                    page =1
                elif mouse_x>=220 and mouse_x<=255 and mouse_y>=300 and mouse_y<=325:
                    if dem_chim_1==3: dem_chim_1=1
                    else: dem_chim_1+=1
                elif mouse_x>=220 and mouse_x<=255 and mouse_y>=445 and mouse_y<=470:
                    if dem_chim_1==1 : dem_chim_1=3
                    else: dem_chim_1-=1
                elif mouse_x>=525 and mouse_x<=560 and mouse_y>=300 and mouse_y<=330:
                    if dem_chim_2==3 : dem_chim_2=1
                    else: dem_chim_2+=1
                elif mouse_x>=525 and mouse_x<=560 and mouse_y>=445 and mouse_y<=470:
                    if dem_chim_2==1 : dem_chim_2=3
                    else: dem_chim_2-=1
                screen_bird()
                if dem_chim_1==1:
                    bird_down= pygame.transform.scale2x(pygame.image.load('assets/yellowbird-downflap.png')).convert_alpha()
                    ...
                    bird_down= pygame.transform.scale2x(pygame.image.load('assets/red1.png')).convert_alpha()
                    bird_mid= pygame.transform.scale2x(pygame.image.load('assets/red2.png')).convert_alpha()
                    bird_up= pygame.transform.scale2x(pygame.image.load('assets/red3.png')).convert_alpha()
                else:
                    bird_down= pygame.transform.scale2x(pygame.image.load('assets/blue1.png')).convert_alpha()
                    bird_mid= pygame.transform.scale2x(pygame.image.load('assets/blue2.png')).convert_alpha()
                    bird_up= pygame.transform.scale2x(pygame.image.load('assets/blue3.png')).convert_alpha()
                if dem_chim_2==3:
                    bird1_down= pygame.transform.scale2x(pygame.image.load('assets/yellowbird-downflap.png')).convert_alpha()
                    bird1_mid= pygame.transform.scale2x(pygame.image.load('assets/yellowbird-midflap.png')).convert_alpha()
                    bird1_up= pygame.transform.scale2x(pygame.image.load('assets/yellowbird-upflap.png')).convert_alpha()
                elif dem_chim_2==1:
                    bird1_down= pygame.transform.scale2x(pygame.image.load('assets/red1.png')).convert_alpha()
                    bird1_mid= pygame.transform.scale2x(pygame.image.load('assets/red2.png')).convert_alpha()
                    bird1_up= pygame.transform.scale2x(pygame.image.load('assets/red3.png')).convert_alpha()
                else:
                    bird1_down= pygame.transform.scale2x(pygame.image.load('assets/blue1.png')).convert_alpha()
                    bird1_mid= pygame.transform.scale2x(pygame.image.load('assets/blue2.png')).convert_alpha()
                    bird1_up= pygame.transform.scale2x(pygame.image.load('assets/blue3.png')).convert_alpha()
                bird_list= [bird_down,bird_mid,bird_up]
                bird1_list= [bird1_down,bird1_mid,bird1_up]
                ...
                if mouse_x>=350 and mouse_x<=450 and mouse_y>=670 and mouse_y<=750:
                    page =1
                elif mouse_x>=280 and mouse_x<=480 and mouse_y>=270 and mouse_y<=350:
                    dem_place=1
                    score_sound.play()
                    bg = pygame.image.load('assets/back5.png').convert()
                    bg = pygame.transform.scale2x(bg)
                    ...
                    bg_3 = pygame.image.load('assets/back4.png').convert()
                    bg_3 = pygame.transform.scale2x(bg_3)
                elif mouse_x>=280 and mouse_x<=480 and mouse_y>=370 and mouse_y<=450:
                    dem_place=2
                    score_sound.play()

                    bg = pygame.image.load('assets/back1.png').convert()
                    bg = pygame.transform.scale2x(bg)

                    bg_1 = pygame.image.load('assets/back2.png').convert()
                    bg_1 = pygame.transform.scale2x(bg_1)

                    bg_2 = pygame.image.load('assets/back3.png').convert()
                    bg_2 = pygame.transform.scale2x(bg_2)

                    bg_3 = pygame.image.load('assets/back0.png').convert()
                    bg_3 = pygame.transform.scale2x(bg_3)
                screen_pick_place()
            elif page ==5:
                if mouse_x>=350 and mouse_x<=450 and mouse_y>=670 and mouse_y<=750:
    ...
    if game_active and page==6:
        ...
        if(bg_x_pos<= -768):
            bg_x_pos = 0
            if dem_bg==0: dem_bg=1
            elif dem_bg==1 and int(score)-int(dem_score)>=10: 
                dem_bg=2
                dem_score=score
            elif dem_bg == 2: dem_bg=3
            elif dem_bg==3 and int(score)-int(dem_score)>=10:  dem_bg=0
        ...
        #xử lí in ra chim ở các mode
        if check2==1:
            screen.blit(rotated_bird,bird_rect)
        else :
            screen.blit(rotated_bird,bird_rect)
            screen.blit(rotate1_bird,bird1_rect)
        #xử lí va chạm để kết thúc trò chơi
        if check2 == 2:
