...
bg_x_pos = 0
bg_1 = pygame.image.load('assets/back5.png').convert()
bg_1 = pygame.transform.scale2x(bg)
bg_x_pos_1 = 0
bg_2 = pygame.image.load('assets/back5.png').convert()
bg_3 = pygame.transform.scale2x(bg)
bg_x_pos_4 = 0
